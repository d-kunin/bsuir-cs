  ...
  public class StubLibraryIndex : ILibraryIndex
  {
    ...
    public bool Save()
    {
      try
      {
        ...
        {
          var xmlSerializer = new XmlSerializer(typeof (StubLibraryIndex));
    ...
    public ILibraryIndex Restore()
    {
      try
      {
        ...
        {
          var xmlSerializer = new XmlSerializer(typeof (StubLibraryIndex));
          var sb = (StubLibraryIndex) xmlSerializer.Deserialize(reader);
          return sb;
        }
      }
      catch (Exception e)
    ...
    public static void PopulateWithStubData(ILibraryIndex index)
    {
      ...
      var keyWordsChooser = new Chooser<string>(keywords.ToList());
      var authorChooser = new Chooser<Author>(index.AllAuthors);
      var categoryChooser = new Chooser<Category>(index.AllCategories);
      ...
      for (int i = 0; i < booksToGenerate; ++i)
      {
        ...
        Book book = index.CreateBook(title.Trim(), authorChooser.ChooseRandom(1, 3), categoryChooser.ChooseRandom(1, 2));
    ...
    {
      private readonly List<T> _mInput;
      ...
      public List<T> ChooseRandom(int minCount, int maxCount)
      {
        ...
        List<int> indeces = GetRandomUniqueSeries(minCount, maxCount, _mInput.Count);
